...
NOTES
Measuer of association between 2 variables
Want to look between indep variables, bcs if they are highly correlated they carry same information, and for some models can be a problem
- colinearity: Highly correlated variables can cause some linear models to not fit
Would prefer different variables to give different information
