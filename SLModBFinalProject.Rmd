...
From evaluating this plot, we were able to understand the shape of the data and discover outliers as well as general trends. For example, almost the entire trend line of Duration vs Instrumentalness is caused by a single outlier. It also confirmed the high correlation between loudness and energy, showing a nice upward direction of the trend line, as well as for valence and danceability (although those data have higher variability).
...
DISCUSS HOW ALL WERE SIGNIFICANT WITH TIME SIGNATURE; Why could that be and how do we approach that information?
...
Plotting the 3 highest t-values below to see... (IS THIS A T-VALUE?)
...
WHY ARE WE HIGHLIGHTING THIS OUTLIER? HOW DOES IT AFFECT THE PARTIAL CORRELATION?
